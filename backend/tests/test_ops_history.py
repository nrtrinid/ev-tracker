...
def test_load_ops_status_snapshot_prefers_durable_rows_and_rebuilds_activity():
    ...
    db = _FakeDB(
        {
            "ops_job_runs": [
                ...
                },
                {
                    ...
                    "source": "scheduler",
                    "status": "completed",
                    "run_id": "scheduled-legacy",
                    "captured_at": _iso(minutes_ago=10),
                    "started_at": _iso(minutes_ago=11),
                    "finished_at": _iso(minutes_ago=10),
                    "duration_ms": 875.0,
                    "total_sides": 33,
                    "alerts_scheduled": 1,
                    "hard_errors": 0,
                ...
                },
                {
                    ...
                    "meta": {
                        ...
                        "manual_settlement_pending": {
                            ...
                            "oldest_commence_time": _iso(minutes_ago=180),
                        },
                    },
                },
                {
    ...
    assert snapshot["last_auto_settle_summary"]["manual_settlement_pending"]["by_sport"]["baseball_mlb"]["prop_bets"] == 2
