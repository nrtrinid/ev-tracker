...
def normalize_sportsbook_link(value: str | None) -> str | None:
    ...
    # Preserve valid links exactly as provided. For BetMGM in particular,
    # state-specific hosts (e.g. sports.nj.betmgm.com) carry routing context that
    # helps mobile app/web handoff; collapsing to a generic host can weaken deeplinks.
    # Only unresolved template placeholders are rejected.
