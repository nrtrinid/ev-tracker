...
export async function GET() {
  ...
  try {
    const endpoint = `${backendBaseUrl.replace(/\/$/, "")}/api/ops/pickem-research/summary`;
    ...
    console.error("Pick'em research bridge error:", error);
    return NextResponse.json(
      { error: "Failed to fetch pick'em research summary" },
