...
export async function GET() {
  ...
  try {
    const endpoint = `${backendBaseUrl.replace(/\/$/, "")}/api/ops/model-calibration/summary`;
    ...
    console.error("Model calibration bridge error:", error);
    return NextResponse.json(
      { error: "Failed to fetch model calibration summary" },
